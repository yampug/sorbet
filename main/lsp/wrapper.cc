...
createGlobalStateAndOtherObjects(string_view rootPath, options::Options &options, int numWorkerThreads,
                                 shared_ptr<spdlog::sinks::stderr_color_sink_mt> &stderrColorSinkOut,
    ...
    stderrColorSinkOut = make_shared<spdlog::sinks::stderr_color_sink_mt>();
...
LSPWrapper::LSPWrapper(unique_ptr<core::GlobalState> gs, shared_ptr<options::Options> opts,
                       ...
                       shared_ptr<spdlog::sinks::stderr_color_sink_mt> stderrColorSink,
