...
def register_sorbet_dependencies():
    ...
    http_archive(
        ...
        patch_cmds = [
            "ruby -i.bak -pe 'sub(%r{#include <unistd.h>}, %q{#ifdef _WIN32\n#include <io.h>\n#include <process.h>\n#else\n#include <unistd.h>\n#endif})' ragel/main.cpp",
            "mkdir -p bin",
    ...
    http_archive(
        name = "rules_bison",
        url = "https://github.com/jmillikin/rules_bison/archive/v0.3.tar.gz",
        sha256 = "d2670ab9fbd72f2840a4c6b0ba1d730d33bec63520523b4eddfc94ad3d5d3705",
        strip_prefix = "rules_bison-0.3",
    )
